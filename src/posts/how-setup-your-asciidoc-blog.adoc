...
Overall I am very happy with the setup! It combines the ease of user and deploy with ease of hosting it. I am currently running it on https://aws.amazon.com/ec2/instance-types/t3/[t3.nano] instance and sill feel like it's to much for it. You should be able easily run this setup in a free tier instance for a year.
